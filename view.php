...
$total_pricee=0;
 ...
 // session_start();
  ...
  $query = "SELECT * FROM `$a` WHERE `checkout`=0";
  ...
  echo '<table id="customers"><tr>
   ...
   <td> <a href='delete.php?id=$result2[id]'>Delete</a></td>
  </tr>";
  ...
  echo "<table><tr padding-left:2000px><center><td><h4>Total: ".$a." </center></h4></td></tr>";



?>
<br>
<center><a href="temp.php" class="btn btn-success">Proceed To Checkout</a></center>
