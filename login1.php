...
<body>
  ...
  <div class="container">
    ...
    <div class="clearfix">
        <pre>
      <a href="loginadmin.php"><button type="button" class="cancelbtn" padding="50px" ><h3>Admin Login</h3></input></a><a></a> 
     <a href="loginuser.php"><button type="button" class="signupbtn" ><h3>User Login</h3></input></a></pre>
    </div>
    <br><br><br><br>
  </div>
</form>
